...
int main() {
    ...
    while (keep_running) {
        ...
        // --- SECCIÓN IMU (AMPLIADA CON GIROSCOPIO) ---
        ...
        std::cout << "\n---------------------------------------- ORIENTACIÓN DEL ROBOT (IMU) ----------------------------------------" << std::endl;
        std::cout << std::fixed << std::setprecision(2);
        std::cout << "  ROLL:  " << std::setw(7) << imu->roll  << " deg  |  " 
                  << "ACC_X: " << std::setw(6) << imu->acc[0] << " g  |  "
                  << "GYRO_X: " << std::setw(7) << imu->gyro[0] << " deg/s" << std::endl;
        
        std::cout << "  PITCH: " << std::setw(7) << imu->pitch << " deg  |  "
                  << "ACC_Y: " << std::setw(6) << imu->acc[1] << " g  |  "
                  << "GYRO_Y: " << std::setw(7) << imu->gyro[1] << " deg/s" << std::endl;
        
        std::cout << "  YAW:   " << std::setw(7) << imu->yaw   << " deg  |  "
                  << "ACC_Z: " << std::setw(6) << imu->acc[2] << " g  |  "
                  << "GYRO_Z: " << std::setw(7) << imu->gyro[2] << " deg/s" << std::endl;
