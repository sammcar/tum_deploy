...
LEG_MATRIX = {
    ...
    "FRONT_LEFT (FL)":   ([1, 2, 3],    50.0,  0.0,  5.0,   0.0,   50.0,  36.0, 7.0,  2.0,   4.0),
    "BACK_RIGHT (BR)":   ([10, 11, 12], 50.0,  0.0,  9.5,   0.0,   50.0,  36.0, 7.0,  2.0,   4.0), 
    "BACK_LEFT (BL)":    ([7, 8, 9],    50.0,  0.0,  6.5,   0.0,   50.0,  36.0, 7.0,  2.0,   4.0),
}
