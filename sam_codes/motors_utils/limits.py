...
LEG_MATRIX = {
    ...
    "FRONT_RIGHT (FR)":  ([4, 5, 6],    700.0,  0.0,  7.0,   0.0,   50.0,  20.0, 7.0,  2.0,   4.0),
    "FRONT_LEFT (FL)":   ([1, 2, 3],    600.0,  0.0,  5.0,   0.0,   50.0,  20.0, 7.0,  2.0,   4.0),
    "BACK_RIGHT (BR)":   ([10, 11, 12], 950.0,  0.0,  9.5,   0.0,   50.0,  20.0, 7.0,  2.0,   4.0), 
    "BACK_LEFT (BL)":    ([7, 8, 9],    650.0,  0.0,  6.5,   0.0,   50.0,  20.0, 7.0,  2.0,   4.0),
}
