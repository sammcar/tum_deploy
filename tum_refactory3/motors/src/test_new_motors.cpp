...
// =========================================================
// FUNCIÓN AUXILIAR: CICLO BLOQUEANTE
// (Se usa solo al inicio para leer sin arrancar el bucle asíncrono)
// =========================================================
...
int main(int argc, char **argv) {
    ...
    // --> AQUÍ USAMOS TU FUNCIÓN CON PROMESA PARA BLOQUEAR <--
    ...
    // 3. Preparar Primer Frame Asíncrono
    for (int id = 1; id <= 3; ++id) {
        moteus::PositionMode::Command cmd;
